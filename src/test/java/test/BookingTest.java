...
public class BookingTest extends BaseTest {
    ...
    public void bookingTicketAsGuestUserTest() {
        ...
        detailsPage.fillTraveller_1_Info(SignupData.TITLE_1,
                SignupData.TRAVELLER_1_FNAME,
                SignupData.TRAVELLER_1_LNAME);
        detailsPage.fillTraveller_2_Info(SignupData.TITLE_2,
                SignupData.TRAVELLER_2_FNAME,
                SignupData.TRAVELLER_2_LNAME);
